...
try:
    ...
    # ❌ ตัดฟีเจอร์ 'density' ออก
    X = df.drop(['quality', 'quality_label', 'density'], axis=1)
    y = df['quality_label']
...
with gr.Blocks(theme=gr.themes.Soft(primary_hue="rose", secondary_hue="rose")) as demo:
    ...
    gr.Examples(
        examples=[
            [7.3, 0.65, 0.0, 1.2, 0.065, 15.0, 21.0, 3.39, 0.47, 10.0],
            [7.8, 0.58, 0.02, 2.0, 0.073, 9.0, 18.0, 3.36, 0.57, 9.5],
            [6.7, 0.58, 0.08, 1.8, 0.097, 15.0, 65.0, 3.28, 0.54, 9.2]
        ],
        inputs=inputs_list,
